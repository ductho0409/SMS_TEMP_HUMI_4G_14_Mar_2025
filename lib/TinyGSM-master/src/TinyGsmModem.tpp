...
protected:
  ...
  bool testATImpl(uint32_t timeout_ms = 10000L)
  {
    ...
    {
      thisModem().sendAT(GF(""));
      if (thisModem().waitResponse(200) == 1)
      {
        return true;
      }
      delay(100);
  ...
  String getModemNameImpl()
  {
    ...
    String res1;
    if (thisModem().waitResponse(1000L, res1) != 1)
    {
      return "unknown";
    }
    res1.replace("\r\nOK\r\n", "");
    ...
    String res2;
    if (thisModem().waitResponse(1000L, res2) != 1)
    {
      return "unknown";
    }
    res2.replace("\r\nOK\r\n", "");
...
protected:
  ...
  int8_t getSignalQualityImpl()
  {
    ...
    if (thisModem().waitResponse(GF("+CSQ:")) != 1)
    {
      return 99;
    }
  ...
  String getLocalIPImpl()
  {
    ...
    if (thisModem().waitResponse(GF("+CGPADDR:")) != 1)
    {
      return "";
    }
